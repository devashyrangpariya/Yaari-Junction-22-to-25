    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
          ...
          >
            <Link href="/home" className="flex items-center space-x-2 sm:space-x-3 group touch-manipulation">
              ...
              <div className="hidden sm:block">
                <h1 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 dark:text-white truncate max-w-48 lg:max-w-none">
                  {APP_METADATA.collegeName}
                </h1>
              </div>
            </Link>
          ...
          {/* Mobile Menu Button */}
          <motion.button
            className="lg:hidden p-3 sm:p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 touch-manipulation min-h-12 min-w-12 sm:min-h-auto sm:min-w-auto flex items-center justify-center"
            onClick={toggleMenu}
              ...
              {NAVIGATION_ITEMS.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <Link
                      href={item.href}
                      className={`flex items-center space-x-3 px-4 py-4 sm:py-3 rounded-lg text-base font-medium transition-all duration-200 touch-manipulation min-h-12 ${
                        isActive
                          ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300'
                          : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white'
                      }`}
